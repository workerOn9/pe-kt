Consider graphs built with the units $A$: ![A](resources/images/0194_GraphA.png) and $B$: ![B](resources/images/0194_GraphB.png), where the units are glued along the vertical edges as in the graph ![fig](resources/images/0194_Fig.png).
